...
3. **Anthropic** — add an Anthropic API credential to **Anthropic Chat Model** (Claude 3.5 Sonnet). The workflow's sticky note estimates roughly 20 cents per 300 tracks classified.
