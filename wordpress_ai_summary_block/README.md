...
3. **Google Sheets** — copy the ["AI Summary WordPress Posts" template](https://docs.google.com/spreadsheets/d/1uO0zaNc5UrLhtdcvETFcZGln_qij-nqpYP06n9GxJUk/) and re-point **Google Sheets - Get rows** and **Google Sheets - Add Row** at your copy's document ID and the `AI-Summarized Posts` sheet, using a service account credential.
